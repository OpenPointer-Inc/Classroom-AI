...
const POLICY_SECTIONS = [
    {
        title: "Overview",
        content: "Panaversity values the privacy of its users and is committed to protecting personal information collected through its website and learning platforms.",
    },
    {
        title: "Information We Collect",
        intro: "We collect the following types of information:",
        list: [
            { bold: "Personal Information:", text: "When you create an account, enroll in courses, or interact with Panaversity’s platforms, we may collect name, email, contact details, and payment info." },
    ...
    },
    {
        ...
        list: [
            ...
            { bold: "Withdrawing Consent:", text: "You may withdraw consent anytime via support@panaversity.org, though this may limit service features." },
...
<div className="rounded-2xl bg-slate-50 p-8 border border-slate-100" >
    ...
    < Link
href = "mailto:support@panaversity.org?subject=Privacy%20Policy%20Inquiry"
className = "text-lg font-medium text-emerald-600 hover:underline"
    >
    support@panaversity.org
</Link>
    </div>
    </div>
    </section>
