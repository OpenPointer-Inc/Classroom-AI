                ...
                <div className="relative z-10 max-w-7xl mx-auto">
                    ...
                    >
                        ...
                        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                            <a href="https://app.classroomai.site/" className="px-8 py-4 bg-green-500 hover:bg-green-400 text-[#03150f] font-bold rounded-xl transition-all duration-300 shadow-[0_0_30px_rgba(34,197,94,0.3)] hover:shadow-[0_0_40px_rgba(34,197,94,0.5)] flex items-center gap-2">
                                Start Free Trial
