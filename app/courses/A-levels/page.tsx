...
const MODULES = [
    {
        ...
        description: "Master A-level Maths with Classroom AI, your 24/7 adaptive tutor. From algebra to calculus, our AI-powered learning builds exam-ready confidence for Cambridge assessments."
    },
    {
        id: 2,
        title: "English: AI Taught English",
        description: "Ace Cambridge English with AI-driven tutoring tailored for A-level students. Get instant feedback on essays, comprehension, and grammar — and write with clarity every time."
    },
    {
        id: 3,
        title: "Physics: AI Taught Physics",
        description: "From forces to quantum mechanics, Classroom AI makes Cambridge Physics click. Adaptive lessons and step-by-step AI guidance help A-level students conquer even the toughest topics."
    },
    {
        id: 4,
        title: "Chemistry: AI Taught Chemistry",
        description: "Make reactions, equations, and organic chemistry finally make sense. Classroom AI personalises every Chemistry lesson for Cambridge A-level with instant marking and smart revision."
    },
    {
        id: 5,
        title: "Computer Science: AI Taught Computer Science",
        description: "Think like a programmer with AI-powered CS tutoring aligned to Cambridge A-level. From algorithms to cybersecurity, Classroom AI makes technical concepts practical and exciting."
    },
    {
        id: 6,
        title: "Biology: AI Taught Biology",
        description: "Bring biology to life with Classroom AI's adaptive learning platform for Cambridge A-level. Master cells, genetics, and ecosystems with personalised lessons and smarter revision."
    },
    {
        id: 7,
        title: "Islamiyat: AI Taught Islamiyat",
        description: "Study Cambridge A-level Islamiyat with culturally sensitive, curriculum-aligned AI tutoring. Classroom AI helps students engage deeply with Quranic studies, Hadith, and Islamic history."
    }
];

const OUTCOMES = [
    "Build exam-ready confidence for Cambridge A-level assessments with AI-guided practice",
                                ...
                                <div className="space-y-6 pr-0 sm:col-span-3 md:col-span-3 md:pr-4 lg:col-span-2">
                                    <div className="space-y-4">
                                        ...
                                        <h1 className="text-3xl mt-2 font-bold xs:text-4xl lg:text-5xl">
                                            AI Taught A-levels: Ace your Studies with AI Today.
                                        </h1>
            ...
            <section className="mx-auto px-4 py-12 lg:max-w-[1200px]">
                <div className="mb-12 space-y-4">
                    ...
                    <p className="text-lg leading-relaxed text-zinc-700">
                        No existing course teaches A-levels Courses with AI. AI is empowering Education and makes learning fun and addictive
